...
# Load other scripts ----
source(here("code", "Custom_Parametric_bootstrap_Functions.R"))
...
# Run Analysis ----
# boot_results = all_boot_reps(B, dat.ma, mod_Y, mod_M, .parallel = F)
tic()
boot_results = all_boot_reps(B, dat.ma, mod_Y, mod_M, .parallel = T)
cat("\n")
toc()
...
save(boot_results_Y, boot_results_M, file = here("data", "Results", "Product_Custom_Boot-Raw.RData"))
